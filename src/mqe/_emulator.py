...
class Emulator:
    ...
    def _is_2(self, rom_cache_bus, data):
        ...
        self.cache[(self._cache_page << 8) + data] = self._acc
    ...
    def _is_3(self, rom_cache_bus, data):
        ...
        self._program_counter = rom_cache_bus - 1
    ...
    def _is_21(self, rom_cache_bus, data):
        # RSC
        if ((self._acc >> rom_cache_bus) << rom_cache_bus) != self._acc:
            self._carry_flag = True
        self._acc = (self._acc >> rom_cache_bus) + (self._carry_flag << 8)
    ...
    def _is_112(self, rom_cache_bus, data):
        # PRW
        self.ports[data] = self._acc

    def _is_113(self, rom_cache_bus, data):
        # PRR
        self._acc = self.ports[data]
    ...
    def execute_step(self):
        ...
        # execute instruction
        self._instruction_set[opcode](rom_cache_bus, data)
